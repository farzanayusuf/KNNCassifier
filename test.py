...
#print ("knn label")
print (knn_predict(X_test.iloc[0], X_train, 2))
...
#test=pd.DataFrame(X_test.apply(lambda x: knn_predict(x, X_train, 2), axis=1)).rename(columns={0: 'Output'})
